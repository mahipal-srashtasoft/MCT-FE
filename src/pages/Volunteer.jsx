...
export default function Volunteer() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {opportunities.map((opportunity, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg" data-aos="fade-up">
      ...
      {/* Application Form */}
      <div className="py-16 bg-white bgImg overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8 text-orange-500" data-aos="fade-down">
