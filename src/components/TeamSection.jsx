...
const team = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?auto=format&fit=crop&q=80&w=300",
      social: {
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&q=80&w=300",
      social: {
    ...
    },
    {
      name: "Ethan Garcia",
      role: "Policy Advisor",
      image: "https://images.unsplash.com/photo-1517423440428-a5a00ad493e8?auto=format&fit=crop&q=80&w=300",
      social: {
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1522091066250-665186289043?auto=format&fit=crop&q=80&w=300",
      social: {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-lg p-6 text-center flex flex-col items-center justify-between">
              <img
                src={member.image}
                alt={member.name}
              ...
              <div className="flex space-x-3">
                <a href={member.social.twitter} target="_blank" className="text-white p-2 rounded-full bg-orange-500 hover:bg-black transition-all duration-300">
                  <FaXTwitter  className="w-5 h-5" />
                </a>
                <a href={member.social.facebook} target="_blank" className="text-white p-2 rounded-full bg-orange-500 hover:bg-black transition-all duration-300">
                  <FaFacebookF className="w-5 h-5" />
                </a>
                <a href={member.social.instagram} target="_blank" className="text-white p-2 rounded-full bg-orange-500 hover:bg-black transition-all duration-300">
